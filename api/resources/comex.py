...
class Comex(Resource):
    def get(self):
        ...
        data_f_comex['MES'] = data_f_comex['ANO'].apply(lambda x: str(x))
        data_f_comex['COD_NCM'] = data_f_comex['ANO'].apply(lambda x: str(x))
        data_f_comex['SG_UF'] = data_f_comex['ANO'].apply(lambda x: str(x))
